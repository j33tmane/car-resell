    ...
    <header>
        <nav class="navbar navbar-expand-md bg-{{ $dealer->social->theme ?? 'secondary' }}"
            ...
            <div class="container">
                ...
                <a class="navbar-brand " href="{{ url('dealer/' . $dealer->user_id) }}"><img
                        src="{{ $dealer->image_url }}" class="img rounded-circle border border-white"
                        style="height: 50px;width: 50px;object-fit: cover;" style="width: 50px !important;">
                    {{-- <span class="fs-4 fw-bold ">{{ $dealer->company_name }} asdasd
                        asdasdasd</span> --}}
                </a>
                <button class="navbar-toggler border border-0 text-white " type="button" data-bs-toggle="collapse"
