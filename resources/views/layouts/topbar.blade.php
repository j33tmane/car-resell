    ...
    <div class="navbar-header">
        ...
        <div class="d-flex">
            <div class="dropdown d-none d-lg-inline-block ms-1 ">
                <button type="button" class="btn header-item noti-icon waves-effect text-primary text-uppercase">
            ...
            <div class="dropdown d-inline-block">
                <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                    ...
                    @if (Auth::user()->dealerProfile)
                        <img class="rounded-circle header-profile-user"
                            src="{{ Auth::user()->dealerProfile->image_url ?? '' }}" alt="Header Avatar">
                    @endif
                    <span
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    ...
                    <a class="dropdown-item" href="{{ url('/dealer-profile') }}"><i
                            class="uil uil-user-check font-size-18 align-middle text-muted me-1"></i> <span
                            class="align-middle">Dealer Info</span></a>
