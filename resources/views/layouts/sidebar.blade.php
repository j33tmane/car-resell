...
<div class="vertical-menu">
    ...
    <div class="navbar-brand-box">
        <a href="" class="logo logo-dark">
            ...
            <span class="logo-sm img-fluid" >
                <img src="{{ URL::asset('/assets/my-img/car-logo.png') }}" alt="" height="50" style="max-width: 180%;" >
            </span>

            <span class="logo-lg app-brand justify-content-center bg-info rounded py-2 px-2 ">

                <img src="{{ URL::asset('/assets/my-img/ABH-logo.png') }}" width="100px" class="m-4">

                {{-- <marquee behavior="scroll" direction="left" scrollamount="10" >
                    <img src="" width="10%"></marquee> --}}
    ...
    <div data-simplebar class="sidebar-menu-scroll">
        ...
        <div id="sidebar-menu">
            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                @if (Auth::user()->getRawOriginal('active') == 0)
                    <li>
                        <a href="{{ url('/verification-pending') }}">
